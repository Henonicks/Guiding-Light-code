		...
		dpp::embed()
			...
			.set_description(
				fmt::format(
					...
					"A Join-To-Create Voice Channel, or, as referred to, a JTC VC (or simply a JTC), is a voice channel which you can join so that a temporary voice is created. "
					...
					"__**{4}**__ adds a user to the blocklist of the channel if a user is provided as the parameter.\n"

					"__**{5}**__ removes a user from the blocklist of the channel if a user is provided as the parameter.\n"

					"__**{6}**__ tells you whether the requested user is in the blocklist or not."
		...
		dpp::embed()
			...
			.set_description(
				fmt::format(
					...
					"You can only get points from voting if you\'ve selected a guild with {1}. Voting for the bot while a guild `X` is selected will be referred to as \"Voting in favour of the guild `X`\". "
					...
					"__**{1}**__ sets the guild you\'re issuing the command in. This means that if you issue this sub-command in the guild `X`, "
					...
					"__**{2}**__ gets the guild you\'re currently voting in favour of. "
					"If you\'ve issued the `set` sub-command in the guild `X`, that\'ll be the guild returned."
		...
		dpp::embed()
			...
			.set_description(
				fmt::format(
					...
					"__**{0}**__ allows the creator of the bot to talk to you through the bot's DMs.\n"
					"__**{1}**__ closes a ticket, ending any conversation between the creator of the bot and you."
					, slash::get_mention("ticket create")
					, slash::get_mention("ticket close")
				)
			),
		dpp::embed()
			.set_color(dpp::colors::sti_blue)
			...
			.set_footer(dpp::embed_footer()
				.set_text("You can always ask the creator of the bot a question in the direct messages or the support server! A link to the latter is in the bio of the bot.")
